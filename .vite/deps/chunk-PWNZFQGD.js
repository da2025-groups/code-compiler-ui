...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider(props) {
    ...
    const element = (0, import_jsx_runtime13.jsxs)(React33.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime13.jsxs)(React33.Fragment, {
...
function createPalette(palette2) {
  const {
    ...
    contrastThreshold = 3,
    tonalOffset = 0.2
  } = palette2, other = _objectWithoutPropertiesLoose(palette2, _excluded15);
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-PWNZFQGD.js.map
